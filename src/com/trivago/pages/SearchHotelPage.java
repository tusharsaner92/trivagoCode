...
//			System.out.println(a.getText());
	...
	public int excelData(int totalHotelsFound) throws IOException {
		...
		File src = new File("/TrivagoAutomationCode/ExcelOutput/testFile.xlsx");
...
//			LowestRate
	...
	public void findDetails(String hotename) throws IOException {
		...
		File src = new File("/Users/apple/eclipse-workspace/TrivagoAutomationCode/ExcelOutput/testFile.xlsx");
		FileInputStream fis = new FileInputStream(src);
		XSSFWorkbook wb = new XSSFWorkbook(fis);
		XSSFSheet Sheet = wb.getSheetAt(0);
