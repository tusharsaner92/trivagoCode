...
import com.trivago.lib.AppLibrary;
import com.trivago.lib.TestBase;
import com.trivago.pages.SearchHotelPage;
...
//		shp.numberOfGuest("1", "0", "1");
		...
		shp.selectCity("Cocoon Hotel");

		shp.findDetails("Cocoon Hotel");
		...
		ImageIO.write(saveImage, "png", new File("Cocoon Hotel.png"));
